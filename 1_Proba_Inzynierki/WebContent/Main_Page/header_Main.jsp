...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/1_Proba_Inzynierki/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template -->
    <link href="/1_Proba_Inzynierki/lib/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="join_Now.jsp">Sing up</a>
            </li>
            <li class="nav-item">
